<?php
    ...
    if (isset($_POST['row']) && isset($_POST['column']) && !empty($_POST['row']) && !empty($_POST['column'])){
        ...
        try{
            ...
            // Seleziono l'utente
            $queryUtente = "SELECT id FROM utenti WHERE username='".$_SESSION['user']."'";
            ...
            if (mysqli_stmt_num_rows($stmt1)==1){
                ...
                if (!mysqli_execute($stmt5)){
                    throw new Exception("Error executing insert statement: ".mysqli_stmt_error($stmt5).", session ID: ".$sessionIdUtente." ".$_SESSION['user']);
                }
