        ...
        if (validateEmail($email)==true){
            ...
            if ( !(mysqli_execute($stmt))){
                ...
                if ( mysqli_stmt_fetch($stmt) ){
                    ...
                    if ($email == $usrnm && $password == $pwd){
                        $_SESSION['user']=$email;
                        
                        echo $_SESSION['user']." utente";
                        return true;
                    } else {
                        return false;
                    }
...
function printLoginArea(){
    ...
    $string .= "    <input type='mail' name='usernameLogin' placeholder='Username'>\n";
    $string .= "    <input type='password' name='passwordLogin' placeholder='Password'>\n";
...
function printSingupArea(){
    ...
    $string .= "   <div class='log-content'>";
    $string .= "   <form  method=POST action=".$_SERVER['PHP_SELF'].">\n";
    $string .= "   <input type='mail' name='usernameSignUp' placeholder='Username'>\n";
    $string .= "   <input type='password' name='passwordSignUp' placeholder='Password'>\n";
